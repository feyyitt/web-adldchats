...
export default function FriendsPage() {
  ...
  return (
    <div className="px-4 md:px-[40px] py-6 md:py-8 max-w-[1200px] mx-auto min-h-screen pt-20 md:pt-8 pb-28 md:pb-8">
      ...
      {activeTab === 'pending' && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl">
          {pendingRequests.length > 0 ? (
            ...
            <div className="col-span-full glass-panel rounded-3xl p-12 text-center max-w-md mx-auto border border-white/10 space-y-2">
              <span className="material-symbols-outlined text-[40px] text-on-surface-variant/40">
                mark_email_read
              </span>
              <h4 className="font-display font-bold text-white text-sm">Tidak Ada Permintaan Pertemanan</h4>
              <p className="font-body text-xs text-on-surface-variant">
                Saat ada yang mengirimi Anda permintaan pertemanan, akan muncul di sini.
              </p>
            </div>
          )}
        </div>
      ...
      {activeTab === 'add' && (
        <div className="w-full max-w-md glass-panel rounded-3xl p-6 sm:p-8 space-y-6 border border-white/10 shadow-2xl">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-zinc-900 border border-white/10 text-on-surface font-body text-sm rounded-xl pl-10 pr-4 py-3 focus:outline-none focus:border-emerald-500 transition-all"
                  required
                />
              </div>
            </div>
