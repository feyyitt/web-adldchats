...
const DEMO_CHATS = [
  {
    id: '1',
    name: 'Kael Mercer',
    message: 'Deploying the new nodes now... 🚀',
    time: 'Just now',
    streak: 12,
    unread: 2,
    online: true,
  },
  {
    id: '2',
    name: 'Marcus Vance',
    message: 'Coba lihat foto terbaru ini! 📸',
    time: '15m ago',
    streak: 24,
    unread: 1,
    online: true,
  },
  {
    id: '3',
    name: 'Nexus Squad 🔥',
    message: 'Raid starts at 22:00 sync up.',
    time: '1h ago',
    streak: 5,
    unread: 0,
    online: false,
            ...
            <div className="space-y-3">
              {DEMO_CHATS.map((chat) => (
                <div
                  key={chat.id}
                  onClick={() => navigate('/chat')}
                  className="w-full glass-panel glass-spotlight rounded-2xl p-4 flex items-center gap-4 cursor-pointer transition-all group"
                >
                  {/* Avatar */}
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              <div>
                ...
                <p className="font-body text-body-md text-on-surface-variant text-xs">
                  5 teman aktif melayang di Peta ADLD Maps real-time
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <p className="font-body text-body-md text-on-surface-variant text-xs">
                  2 permintaan pertemanan menunggu konfirmasi
                </p>
              </div>
            </div>
          </section>
          ...
          <div className="glass-panel glass-spotlight rounded-3xl p-6 relative overflow-hidden group border border-amber-500/30 shadow-xl">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="font-body text-label-sm text-amber-400 font-semibold">Streak Tertinggi: 24 Hari</p>
              </div>
            </div>
